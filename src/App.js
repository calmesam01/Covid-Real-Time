...
function App() {
  ...
  return (
    <div className="App">
    <strong><h1 style={{ textAlign: "center", marginBottom: 50, marginLeft: 100, marginRight: 100, marginTop: 50 }}>
    Real Time Corona Meter</h1></strong>
